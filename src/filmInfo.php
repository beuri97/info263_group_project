...
<head>
    <meta charset="UTF-8">
    <title>Star Wars - Film Info</title>
...
<?php
if (!isset($_GET["id"])) {
    echo "<h1>" . "ERROR: NO FILM SELECTED " . "</h1>";
} else {
    ...
    //producers section of databank table
    ...
    //cast section of databank table
    } elseif ($section === 'cast') {
    ...
    //planets section of databank table
    ...
    //vehicles section of databank table
    ...
    //starship section of databank table
